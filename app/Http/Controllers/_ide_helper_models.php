...
namespace App\Models{
     ...
     * @property int|null $kategori_buku_id
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property-read \App\Models\KategoriBuku|null $kategori_buku
...
namespace App\Models{
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|Transaksi whereIsbn($value)
